...
# !git lfs install
# !git clone https://huggingface.co/datasets/LeoFeng/MLHW_6
# !powershell -Command "Expand-Archive -Path './MLHW_6/faces.zip' -DestinationPath '.'"
#%% md
# ## Other setting
#%%
# import module
...
trainer.inference(f'{workspace_dir}/checkpoints/2025-04-05_17-24-10_GAN/G_0.pth') # you have to modify the path when running this line
#%% md
